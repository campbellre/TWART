<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bankedit.aspx.cs" Inherits="TWART.Views.Customer.bankedit" %>
...
<body>
    ...
    <div id="main">
        ...
        <section id="admin" class="top">
            <div class="container">
                <header>
                    <h2>Change Account Number and SortCode</h2>
                </header>
            </div>
        </section>
        <!-- Edit Here -->
        <section id="edit" class="two">
            <div class="container">
                <% Bank editCustomer = (Bank)Model; %>
                <form action="/Bank/Edit" method="POST">
                    <input maxlength="49" type="text" name="name" value="<%= bankList.ID %>" />
