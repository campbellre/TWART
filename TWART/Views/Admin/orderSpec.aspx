...
<body>
        ...
        <div class="top">
            ...
            <nav id="nav">
                <ul>
                    ...
                    <li><a href="#newpackage" id="newpackagespec" class="skel-layers-ignoreHref"><span class="icon fa-plus">New Package</span></a></li>
                    <li><a href="#packagelist" id="packagelistSection" class="skel-layers-ignoreHref"><span class="icon fa-list">Package List</span></a></li>
                </ul>
            </nav>
        </div>
        <div class="bottom">
    ...
    <div id="main">
        ...
        <!-- Packages -->
        <section id="packagelist" class="two">
            <div class="container">
                <form id="orderSpec" runat="server">
                    <table>
